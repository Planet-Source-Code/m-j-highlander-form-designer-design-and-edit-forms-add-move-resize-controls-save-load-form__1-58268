...
'SetParent frmFormDesign.hWnd, frmMain.hWnd
Load frmFormDesign
Load frmMain

frmFormDesign.Show vbModeless, frmMain
frmMain.Show

'frmFormDesign.Left = (frmMain.ScaleWidth - frmFormDesign.Width) \ 2 '- frmMain.Left
'frmFormDesign.Top = (frmMain.ScaleHeight - frmFormDesign.Height) \ 2
